          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                buildSection(
                  "1. Qu'est-ce que HOORA ?",
                  "HOORA est une application innovante conçue pour encourager les gens à visiter des spots touristiques pendant les heures creuses. Elle propose une carte interactive affichant les sites touristiques avec des indications de couleur (vert, orange, rouge) pour représenter l'affluence prévue. En visitant ces sites aux moments idéaux, les utilisateurs peuvent gagner des points échangeables contre des avantages chez nos partenaires.",
                ),
                buildSection("2. Comment puis-je créer un compte sur HOORA ?",
                    "Pour accéder à HOORA, il est nécessaire de télécharger l'application et de créer un compte en utilisant une adresse e-mail valide et un mot de passe. Ce processus permet de sécuriser votre accès et de personnaliser votre expérience."),
                buildSection("3. L'application est-elle gratuite ?",
                    "Oui, HOORA est totalement gratuite. Les utilisateurs peuvent gagner des points et les utiliser pour obtenir des avantages exclusifs chez nos partenaires sans frais supplémentaires."),
                ...
                buildSection("5. Comment fonctionne le système de points sur HOORA ?",
                ...
                buildSection("6. Comment puis-je valider ma visite et gagner des points ?",
                    "Pour valider une visite, sélectionnez l'option \"Je valide ma visite\" sur l'application. Vous devrez autoriser HOORA à accéder à votre géolocalisation pour confirmer votre présence sur le site touristique. Une fois la visite validée, les points seront ajoutés à votre profil."),
                ...
                buildSection("8. Comment puis-je contacter le support de HOORA ?",
                ...
                buildSection("9. L'application est-elle disponible sur iOS et Android ?",
                    "Oui, HOORA est disponible à la fois sur iOS et Android, vous permettant d'accéder à nos services peu importe votre appareil."),

                buildSection("10. Comment HOORA garantit elle la sécurité et la confidentialité de mes données ?",
                    "Nous prenons la sécurité et la confidentialité des données très au sérieux. HOORA collecte des données personnelles conformément aux lois en vigueur, notamment la géolocalisation, à des fins d'analyse et d'amélioration de l'application. Nous avons mis en place des mesures rigoureuses pour garantir la protection de vos données."),
